...
@WebServlet("/Coordinator/CoursesAdd")
public class CoordinatorCourseAddController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		coordinatorCourseService.doLoadCourseAddPage(request, response);
	}

	// controller endpoint to submit new course
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {

		coordinatorCourseService.doAddCourse(request, response);
	}
}
